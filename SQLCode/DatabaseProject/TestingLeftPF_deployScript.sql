...
CREATE DATABASE [$(DatabaseName)]
    ...
    FILEGROUP [PrevYearFGQ02](NAME = [PrevYearFileQ2], FILENAME = '$(PRTData)$(DefaultFilePrefix)_PrevYearFileQ2.ndf'), 
    FILEGROUP [CurrentYearFG14](NAME = [CurrentYearFile14], FILENAME = '$(PRTData)$(DefaultFilePrefix)_CurrentYearFile14.ndf'), 
    FILEGROUP [CurrentYearFG13](NAME = [CurrentYearFile13], FILENAME = '$(PRTData)$(DefaultFilePrefix)_CurrentYearFile13.ndf') COLLATE SQL_Latin1_General_CP1_CI_AS
GO
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [CurrentYearFG10_179D997F], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_CurrentYearFG10_179D997F.mdf') TO FILEGROUP [CurrentYearFG10];
...
CREATE PARTITION FUNCTION [PF_CurrentYear](DATE)
    AS RANGE LEFT
    FOR VALUES (
	'2021-01-31 23:59:59.99999', '2021-02-28 23:59:59.99999', '2021-03-31 23:59:59.99999',
	'2021-04-30 23:59:59.99999', '2021-05-31 23:59:59.99999', '2021-06-30 23:59:59.99999', '2021-07-31 23:59:59.99999', 
	'2021-08-31 23:59:59.99999', '2021-09-30 23:59:59.99999', '2021-10-31 23:59:59.99999', '2021-11-30 23:59:59.99999', '2021-12-31 23:59:59.99999' );
...
CREATE PARTITION SCHEME [PS_CurrentYear]
    ...
    TO ([CurrentYearFG01], [CurrentYearFG02], [CurrentYearFG03], [CurrentYearFG04], [CurrentYearFG05], [CurrentYearFG06], 
	[CurrentYearFG07], [CurrentYearFG08], [CurrentYearFG09], [CurrentYearFG10], [CurrentYearFG11], [CurrentYearFG12], [CurrentYearFG13], [CurrentYearFG14]);
...
CREATE PARTITION SCHEME [PS_PrevYear]
    ...
    TO ([PrevYearFGQ02], [PrevYearFGQ03], [PrevYearFGQ04]);
...
SELECT
 @VarDecimalSupported = 1;

IF (@VarDecimalSupported > 0)
    BEGIN
EXECUTE sp_db_vardecimal_storage_format N'$(DatabaseName)'
									  , 'ON';
END
