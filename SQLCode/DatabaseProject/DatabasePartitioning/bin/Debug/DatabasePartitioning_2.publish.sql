...
CREATE DATABASE [$(DatabaseName)]
    ...
    FILEGROUP [CurrentYearFG00](NAME = [CurrentYearFile00], FILENAME = '$(PRTData)$(DefaultFilePrefix)_CurrentYearFile00.ndf'), 
...
CREATE PARTITION FUNCTION [PF_CurrentYear](DATE)
    AS RANGE RIGHT
    FOR VALUES ('20210101', '20210201', '20210301', '20210401', '20210501', '20210601', '20210701', '20210801', '20210901', '20211001', '20211101', '20211201');
...
CREATE PARTITION SCHEME [PS_CurrentYear]
    ...
    TO ([CurrentYearFG00], [CurrentYearFG01], [CurrentYearFG02], [CurrentYearFG03], [CurrentYearFG04], [CurrentYearFG05], [CurrentYearFG06], [CurrentYearFG07], [CurrentYearFG08], [CurrentYearFG09], [CurrentYearFG10], [CurrentYearFG11], [CurrentYearFG12], [CurrentYearFG13]);
