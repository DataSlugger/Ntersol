CREATE OR REPLACE VIEW vwMLBPreviousDayGames
AS
...
WHERE m.officialdate = ((NOW() AT TIME ZONE 'America/Chicago') :: DATE - INTERVAL '1 day') :: DATE
--((CURRENT_DATE at TIME ZONE 'CST')::DATE - INTERVAL '1 day')::DATE
